# REST-сервис для управления и агрегации пользовательских подписок
...
### Все параметры
| Раздел | Параметр | YAML ключ | ENV переменная | Значение по умолчанию |
|---------|-----------|------------|----------------|------------------------|
...
|  | Имя базы данных | — | `POSTGRES_DB` | `subscriptions` |
